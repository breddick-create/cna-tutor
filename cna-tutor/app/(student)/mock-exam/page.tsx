        ...
        <div className="mt-6 grid gap-3 sm:flex sm:flex-wrap">
          ...
          {domains.map((domain) => (
            <Link
              ...
              href={`/mock-exam?domain=${domain.slug}`}
            >
              {domain.title}
            </Link>
          ))}
      ...
      {fullMockLocked ? (
        <section className="panel rounded-[1.75rem] p-5 sm:p-6">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link className="button-primary w-full sm:w-auto" href="/study-plan">
              Continue study plan
            </Link>
            <Link
              className="button-secondary w-full sm:w-auto"
              href={progression.priorityOrder[0]?.domainSlug ? `/quiz?domain=${progression.priorityOrder[0].domainSlug}` : "/quiz"}
            >
              Take practice quiz
            </Link>
          </div>
        ...
        <section className="space-y-6">
          <section className="panel rounded-[1.75rem] p-5 sm:p-6">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Link className="button-secondary w-full sm:w-auto" href={selectedDomain?.slug ? `/quiz?domain=${selectedDomain.slug}` : "/study-plan"}>
