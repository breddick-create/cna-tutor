...
const expectationCards = [
  {
    ...
    description:
      "The written pre-test decides where your written study plan starts, so you can focus on the knowledge domains that need the most help first.",
  },
  {
...
const nextSteps = [
  "Your results will show which written exam domains already look stronger and which ones need more help.",
  "The app will build your personalized written study plan automatically.",
  "You will know which lesson, quiz, or review step to do first.",
];

export default async function WrittenPretestIntroPage() {
  await requireViewer();

  return (
    <div className="space-y-8">
      <section className="panel-strong rounded-[1.75rem] p-6 sm:p-8">
        <p className="eyebrow">Required Written Pre-Test</p>
        <h1 className="mt-3 max-w-4xl text-3xl font-semibold leading-tight sm:text-4xl">
          Start with a short written pre-test so the app can build the right study plan for you.
        </h1>
        <p className="text-muted mt-4 max-w-3xl leading-7">
          This step is here to help, not to judge. The written pre-test is designed to identify
          your strengths and weak areas across the 8 written exam domains so HCCI Tutor can guide
          you with more structure and confidence.
        </p>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="panel rounded-[1.75rem] p-6">
          ...
          <h2 className="mt-3 text-3xl font-semibold">Start the written pre-test now.</h2>
          <p className="text-muted mt-3 max-w-3xl leading-7">
            Finish this first check so the app can show your weak written exam domains and build
            the study plan you should follow next.
          </p>
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link className="button-primary flex-1" href="/written/pretest/start">
              Start Written Pre-Test Now
            </Link>
